...
* `bfactor_interpret()` classifies the strength of the evidence implied by a Bayes factor according to interpretation scales suggested by @jeffreys1961 or @kass1995.
...
Because Bayes factors are often reported on a logarithmic scale, there is also a `bfactor_log_interpret()` functions that interprets the logarithms of Bayes factors:

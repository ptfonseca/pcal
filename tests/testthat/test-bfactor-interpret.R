...
context("bfactor_interpret jeffreys")

test_that("bfactor_interpret scale argument", {
  expect_equal(
...
test_that("bfactor_interpret error message 1 test 2", {
  expect_error(
...
test_that("bfactor_interpret error message 2 - empty vector", {
  expect_error(
    bfactor_interpret(vector())
  )}
)

test_that("bfactor_interpret error message 2 - empty list", {
  expect_error(
    bfactor_interpret(list())
  )}
)

test_that("bfactor_interpret error message 3 - NA test 1", {
  expect_error(
    bfactor_interpret(NA)
  )}
)

test_that("bfactor_interpret error message 3 - NA test 2", {
  expect_error(
    bfactor_interpret(NA, scale = "jeffreys" )
  )}
)

test_that("bfactor_interpret error message 3 - NaN", {
  expect_error(
    bfactor_interpret(NaN)
  )}
)

test_that("bfactor_interpret error message 4 - factor", {
  expect_error(
    bfactor_interpret(factor(10))
  )}
)

test_that("bfactor_interpret error message 4 - char", {
  expect_error(
    bfactor_interpret("10")
  )}
)

test_that("bfactor_interpret error message 4 - list", {
  expect_error(
    bfactor_interpret(list(10))
  )}
)

test_that("bfactor_interpret error message 5", {
  expect_error(
...
context("bfactor_interpret kass-raftery")

test_that("bfactor_interpre kass-rafteryt test 1", {
  expect_equal(
...
test_that("bfactor_interpret kass-raftery error message 1", {
  expect_error(
    bfactor_interpret(NULL, scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 2 - empty vector", {
  expect_error(
    bfactor_interpret(vector(), scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 2 - empty list", {
  expect_error(
    bfactor_interpret(list(), scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 3 - NA", {
  expect_error(
    bfactor_interpret(NA, scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 3 - NaN", {
  expect_error(
    bfactor_interpret(NaN, scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 4 - factor", {
  expect_error(
    bfactor_interpret(factor(10), scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 4 - char", {
  expect_error(
    bfactor_interpret("10", scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 4 - list", {
  expect_error(
    bfactor_interpret(list(10), scale = "kass-raftery")
  )}
)

test_that("bfactor_interpret kass-raftery error message 5", {
  expect_error(

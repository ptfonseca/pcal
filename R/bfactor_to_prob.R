...
#' * \code{\link[pcal]{bfactor_interpret_jeffreys}} and \code{\link[pcal:bfactor_interpret_jeffreys]{bfactor_interpret_kass}} for the interpretation of Bayes factors.

...
#'
#' @details \code{pcal} generalizes the calibration of p-values into lower bounds on the posterior probabilities of point null hypotheses or lower bounds on the probabilities of type I errors developed in \insertCite{sellke2001;textual}{pcal} for prior probabilities other than 0.5.
#'

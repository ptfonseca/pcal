...
#'
#' For a complete list of functions see `library(help = "pcal")`. For tutorials and examples see the [README](https://github.com/pedro-teles-fonseca/pcal/blob/master/README.md).
#'
#' @references
#' \insertAllCited{}
#'
